  ...
  <div class="container">
    ...
    <div class="skillsx-grid">
      ...
      <div class="skillsx-card is-lang">
        ...
        <div class="skillsx-item">
          <div class="skillsx-row"><span class="skillsx-name">English</span><span class="skillsx-level">100%</span></div>
          <div class="skillsx-bar"><span class="skillsx-fill" data-width="100"></span></div>
        </div>

        <div class="skillsx-item">
          <div class="skillsx-row"><span class="skillsx-name">German</span><span class="skillsx-level">87%</span></div>
          <div class="skillsx-bar"><span class="skillsx-fill" data-width="87"></span></div>
        </div>

        <div class="skillsx-item">
          <div class="skillsx-row"><span class="skillsx-name">Malayalam</span><span class="skillsx-level">100%</span></div>
          <div class="skillsx-bar"><span class="skillsx-fill" data-width="100"></span></div>
        </div>
      </div>
